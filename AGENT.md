...
- A note is one continuous, flat block document. Text and single-item to-do blocks may appear in any order.
...
- The dotted header grip moves a note; the bottom-right grip resizes it; a block's hover grip reorders it without competing with text selection.
