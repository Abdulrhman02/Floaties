# Floaties documentation

This directory contains the maintained technical and product documentation for Floaties.

| Document | Read it when… |
| --- | --- |
| [FEATURES.md](FEATURES.md) | Changing user-visible controls or behavior |
...
Documentation is part of the change, not a later cleanup step. Use the update matrix in [AGENT.md](../AGENT.md#documentation-update-matrix) to identify which files must change with the code.
